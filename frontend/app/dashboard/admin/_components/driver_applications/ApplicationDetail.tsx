            ...
            <div className="gap-2 flex flex-col">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex gap-1 items-center">
                  ...
                  <p className="font-light ">{data?.data?.status === "Pending" && "Applied on:" || data?.data?.status === "Approved" && "Approved on:" || data?.data?.status === "Pending" && "Applied on:" || data?.data?.status === "Reejcted" && "Rejected on:"} <span className="font-medium">{formatDate(data?.data?.createdAt)}</span></p>
                </div>
              </div>
            </div>
          </div>
