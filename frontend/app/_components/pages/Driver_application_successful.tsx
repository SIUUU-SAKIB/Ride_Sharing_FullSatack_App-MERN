...
const Driver_application_successful = () => {
  return (
    <div className="max-w-3xl mx-auto flex flex-col items-center justify-center gap-6 z-50 py-16 relative">
        ...
        <h1 className='text-2xl font-bold'>Application Submitted Sucessfully</h1>
        <p className='max-w-150 text-center text-(--neutral)'>
            Your applicatoin is under review.<br/> We will notify you once it has been<br/> approved
        </p>
        <Link href={`/driver/dashboard`} className='w-2/3  bg-(--primary) rounded-lg shadow-xs py-2 font-semibold text-white  shadow-emerald-400 text-center '>Go to Dashboard</Link>
