...
const BottomNav = () => {
    return (
        <div className='fixed bottom-0 max-w-7xl bg-white mx-auto'>
            <ul className='flex items-center w-full justify-between bg-white shadow-sm py-4 text-gray-400 px-12 mx-auto z-10'>
